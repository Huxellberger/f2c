...
-=-=-=-=-=-=
   ...
   major by right-clicking in the watch window and choosing "Column Major Display". These take the form:
      ...
      format specifiers:
         ...
         mtx4x3 : display 4 x 3 matrix
         mtx3x4 : display 3 x 4 matrix
   ...
   to the sixth array element and __index evaluates to, simply, 5.
      ...
      # Create a two-column table display the width and height of each box in an array of boxes
...
-=-=-=-=-=-=
   ...
   of enable processor breakpoints to 4.
